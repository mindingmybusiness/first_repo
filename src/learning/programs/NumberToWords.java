...
public class NumberToWords {
	 ...
	 * 
	 * One Two Three They don't have to be separated by a space.
	 * 
	...
	public static void main(String[] args) {
		int number = 100123400;
		numberToWords(number);
		/*
		 * System.out.println(reverse(100)); System.out.println(getDigitCount(0));
		 */
	}
	...
	public static void numberToWords(int number) {
		...
		int revDigiCount = getDigitCount(reversedNum);
		...
		if(digitCount != revDigiCount) {
			for(int i = 0;i<(digitCount-revDigiCount);i++) {
				System.out.print("Zero" + " ");
			}
		}
	}
